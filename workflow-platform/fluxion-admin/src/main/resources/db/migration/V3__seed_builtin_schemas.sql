-- ============================================================
-- V3：批量初始化 10 个常用可复用 Schema 到 wf_schema 表
--   覆盖通用分页、用户、订单、支付、通知、缓存等能力域，
--   供工作流入参/出参通过 $ref:schema:<name> 引用。
-- ============================================================

INSERT IGNORE INTO `wf_schema` (`schema_name`, `schema_type`, `schema_json`, `description`) VALUES
