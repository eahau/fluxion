 ...
 *   - A layered `InboundRouter` that wraps the runtime executor with idempotency + distributed
...
class WorkflowCoreConfiguration {
     ...
     *
     * Delegates to the runtime `RuntimeInboundRouter` for core execution, then conditionally
