/**
 * Constructs [OutboundConfig] instances from an operator-authored
 ...
 *    first-class promotion into [OutboundConfig.extras] when the
 ...
 * [OutboundConfig] records.
 */
object OutboundConfigParser {

    @JvmStatic
    @Suppress("UNCHECKED_CAST")
    fun parse(config: Map<String, Any>?): OutboundConfig {
        if (config.isNullOrEmpty()) return OutboundConfig()
