// fluxion-script:core - Embedded script execution engine core module (zero Spring).
...
dependencies {
    ...
    // Fluxion cache - configurable cache abstraction for compiled Groovy Class objects.
