...
import com.fluxion.inbound.rpc.grpc.GrpcWorkflowServiceImpl
 ...
 *
 * @param inboundRouter Protocol-agnostic router provided by runtime-core.
...
open class GrpcWorkflowService(
    ...
    private val delegate = GrpcWorkflowServiceImpl(inboundRouter, schemaRegistry, providerRegistry)
