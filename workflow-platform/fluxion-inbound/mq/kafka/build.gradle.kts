// fluxion-inbound:mq:kafka - Apache Kafka MQ protocol adapter implementation (zero Spring).
...
dependencies {
    // Core base types (WorkflowDefinition, WorkflowTrigger, TriggerFunctionMeta SPI).
    implementation(project(":fluxion-core"))
    // Inbound SPI: UnifiedRequest, InboundRouter.
    implementation(project(":fluxion-inbound:spi"))
    // Outbound MQ SPI: MqPublisher, MqPublishResult.
