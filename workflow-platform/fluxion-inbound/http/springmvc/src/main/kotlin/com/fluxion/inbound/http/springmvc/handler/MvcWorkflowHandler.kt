...
import com.fluxion.inbound.http.core.HttpRequestProcessor
import com.fluxion.inbound.http.core.HttpRequestProcessor.ATTR_ROUTE_MATCH
import com.fluxion.inbound.http.core.HttpRequestProcessor.HEADER_EXECUTION_ID
import com.fluxion.inbound.http.core.RouteMatch
import com.fluxion.inbound.http.core.mergeParams
 ...
 * into the protocol-agnostic [UnifiedRequest] consumed by [InboundRouter].
 *
 * Extracts:
...
class MvcWorkflowHandler(
     ...
     * 3. Delegate to the shared [InboundRouter] (coroutine-native suspend path).
    ...
    suspend fun handle(
        ...
        val result = inboundRouter.executeSuspend(unifiedRequest)
