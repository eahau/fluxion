// fluxion-function:external:http:spring-boot - Spring Boot auto-configuration for HTTP external function transport.
...
dependencies {
    ...
    api(project(":fluxion-function:external:http"))
